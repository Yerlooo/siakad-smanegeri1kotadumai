            ...
            <div class="mb-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">Perbarui data guru {{ guru.name }}</p>
                    </div>
                </div>
            </div>
                ...
                <form @submit.prevent="submit" class="p-6 space-y-6">
                    ...
                    <div class="border-t border-gray-200 pt-6 flex justify-end space-x-4">
                        ...
                        >
                            ...
                            <span>{{ form.processing ? 'Menyimpan...' : 'Perbarui Data' }}</span>
                        </button>
                    </div>
                </form>
            </div>
...
const submit = () => {
    form.put(route('guru.update', props.guru.id), {
        onSuccess: () => {
